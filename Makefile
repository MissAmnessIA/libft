...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/10/04 13:41:58 by vmesa-ke          #+#    #+#              #
#    Updated: 2025/02/07 18:18:00 by vmesa-ke         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
NAME				= libft.a
...
FTPRINTF_DIR		= $(SRC_DIR)ft_printf/basics.c \
					  $(SRC_DIR)ft_printf/ft_printf.c \
					  $(SRC_DIR)ft_printf/put_type.c

GNL_DIR				= $(SRC_DIR)get_next_line/get_next_line.c \
					  $(SRC_DIR)get_next_line/get_next_line_utils.c

SRC					= $(FTIS_DIR) $(FTLST_DIR) $(FTMEM_DIR) $(FTPRINTF_DIR) $(FTPUT_DIR) $(FTSTR_DIR) $(FTTO_DIR) $(GNL_DIR)
